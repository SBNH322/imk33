...
// Get chat history dengan 1 user
...
io.on("connection", (socket) => {
  ...
  socket.on("dm", (payload) => {
    ...
    const info = db
      ...
      .run(msg.sender_id, msg.receiver_id, msg.text, msg.created_at);

    const out = { id: info.lastInsertRowid, ...msg };

    // kirim realtime ke penerima dan pengirim
